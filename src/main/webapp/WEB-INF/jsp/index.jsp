...
<body>
	...
	<c:choose>
		...
		<c:when test="${mode == 'MODE_TASKS'}">
			<div class="container text-center" id="tasksDiv">
				...
				<script>
					    var jsTasksArr = new Array();     
					    <c:forEach items="${tasks}" var="ctag" varStatus="loop">
					    jsTasksArr.push('${ctag.name}');
					    jsTasksArr.push('${ctag.description}');      
					    jsTasksArr.push('${ctag.categoryName}');      
					    jsTasksArr.push('${ctag.priority}');      
					    </c:forEach>
				</script>
	
   				<button class="btn btn-primary" id="passtopdf" onclick="passToPpf(jsTasksArr);">Export Tasks To PDF</button>
    ...
    <script src="static/js/lib/pdfmake.min.js"></script>
    <script src="static/js/lib/vfs_fonts.js"></script>
    <script src="static/js/bootstrap.min.js"></script>
    <script src="static/js/sorttable.js"></script>
    <script src="static/js/passToPdf.js"></script>
</body>
</html>